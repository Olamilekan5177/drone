    ...
    <section className="flex flex-col justify-center items-center px-11 pb-11 pt-10">
      <div className="grid lg:grid-cols-2  md:grid-cols-2 sm:grid-cols-1 items-center  lg:gap-0.5 md:gap-10">
        ...
        <div className="flex flex-col items-center justify-center pt-10 ">
          <div className="flex items-center py-10  md:py-0 sm:bg-stone-100 bg-stone-100 md:bg-transparent lg:bg-transparent rounded-2xl flex-col min-w-sm lg:-mt-20">
            ...
            <div className="div2 pt-4">
              ...
              />
                ...
                <button className="bg-black w-full text-white py-1.5 px-4 rounded-md mt-5 signup-btn transition duration-200 ease-in-out hover:bg-gray-800">
                  Sign Up
                </button>
              </form>
            </div>
